...
def write_insfile(insfile_name, hyd_sys, pr_path, vpd_path, root=ROOT):
    ...
    param "file_gridlist" (str "{root}/grd/FLUXNET2015_gridlist.txt")

    param "file_mip_noy" (str "{root}/env/ndep_NOy_2011_1x1deg.nc")
    param "file_mip_nhx" (str "{root}/env/ndep_NHx_2011_1x1deg.nc")

    param "file_co2"      (str "{root}/env/co2_1764_2016_observed.dat")
    param "file_soildata" (str "{root}/env/soils_lpj.dat")

    param "file_temp"     (str "{root}/FLUXNET2015/tas_FLUXNET2015.nc")
    param "variable_temp" (str "tas")

    param "file_prec"     (str "{pr_path}")
    param "variable_prec" (str "pr")

    param "file_insol"      (str "{root}/FLUXNET2015/rsds_FLUXNET2015.nc")
    param "variable_insol"  (str "rsds")

    param "file_wind"     (str "{root}/FLUXNET2015/wind_FLUXNET2015.nc")
    ...
    !param "file_specifichum"      (str "/home/konni/Documents/konni/projekte/phd/drought_heat_mip/inputs/control_Qair_lpj.nc")
    ...
    param "file_pres"     (str "{root}/FLUXNET2015/ps_FLUXNET2015.nc")
